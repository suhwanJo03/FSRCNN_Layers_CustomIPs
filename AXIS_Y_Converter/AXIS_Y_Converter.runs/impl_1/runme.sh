...
HD_PWD='D:/FSRCNN/ip_repo/Y_Converter_19.1/Y_Converter_19.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Y_Converter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Y_Converter.tcl -notrace
