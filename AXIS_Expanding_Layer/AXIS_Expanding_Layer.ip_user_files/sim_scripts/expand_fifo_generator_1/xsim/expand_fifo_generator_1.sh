...
#
# Script generated by Vivado on Sat Sep 06 17:54:19 +0900 2025
...
#
# Usage        : expand_fifo_generator_1.sh
#                expand_fifo_generator_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                expand_fifo_generator_1.sh [-reset_run]
#                expand_fifo_generator_1.sh [-reset_log]
#                expand_fifo_generator_1.sh [-help]
#
...
# script info
echo -e "expand_fifo_generator_1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./expand_fifo_generator_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot expand_fifo_generator_1 xil_defaultlib.expand_fifo_generator_1 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb expand_fifo_generator_1.wdb xsim.dir libdpi.so)
...
Usage: expand_fifo_generator_1.sh [-step]\n\
Usage: expand_fifo_generator_1.sh [-lib_map_path]\n\
Usage: expand_fifo_generator_1.sh [-reset_run]\n\
Usage: expand_fifo_generator_1.sh [-reset_log]\n\
Usage: expand_fifo_generator_1.sh [-keep_index]\n\
