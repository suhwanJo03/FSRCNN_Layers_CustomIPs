...
#
# Script generated by Vivado on Sat Sep 06 19:52:23 +0900 2025
...
#
# Usage        : shrink_dsp_macro_1.sh
#                shrink_dsp_macro_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                shrink_dsp_macro_1.sh [-reset_run]
#                shrink_dsp_macro_1.sh [-reset_log]
#                shrink_dsp_macro_1.sh [-help]
#
...
# script info
echo -e "shrink_dsp_macro_1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./shrink_dsp_macro_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_dsp48_wrapper_v3_0_4 -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L dsp_macro_v1_0_3 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot shrink_dsp_macro_1 xil_defaultlib.shrink_dsp_macro_1 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb shrink_dsp_macro_1.wdb xsim.dir libdpi.so)
...
Usage: shrink_dsp_macro_1.sh [-step]\n\
Usage: shrink_dsp_macro_1.sh [-lib_map_path]\n\
Usage: shrink_dsp_macro_1.sh [-reset_run]\n\
Usage: shrink_dsp_macro_1.sh [-reset_log]\n\
Usage: shrink_dsp_macro_1.sh [-keep_index]\n\
